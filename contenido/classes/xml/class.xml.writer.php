...
class cXmlWriter extends cXmlBase {
     ...
     *         created DOM element
     */
    public function addElement($name, $value = '', $rootElement = null, $attributes = [], $cdata = false) {
     ...
     */
    protected function _addElementAttributes(DOMElement $element, array $attributes = []) {
