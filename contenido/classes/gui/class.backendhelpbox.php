...
class cGuiBackendHelpbox {
	 ...
	 * @param string $returnAsString if true the rendered button will be returned. Otherwise it will be echoed
	 * @return string|null the rendered button or nothing if it's been printed
	 */
