...
class cTemplate
{
     ...
     * @param bool $note [optional] Echo "Generated by ... " Comment
...
//            $content = str_replace("</head>", '<meta http-equiv="Content-Type" content="text/html; charset=' . $this->_encoding . '">' . "\n" . '</head>', $content);
     ...
     *
     * @param string $template Contents of the template to translate.
    ...
    public function replacei18n(&$template, $functionName)
    {
        ...
        // TODO The `$container` variable seems to be a left over from previous times.
        //      Remove it if it isn't in use anymore!
