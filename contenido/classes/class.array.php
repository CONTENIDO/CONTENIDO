...
class cArray {
     ...
     * given by $arr, and not from the subarrays (todo: add flag to allow this)
     *
     * @param  array  $arr  The array to search
     * @param  mixed  $search  The value to search in the array
     * @param  bool  $partial
     * @param  bool  $strict
     * @return  mixed|bool  The key/index of the array containing the searched value or false.
     */
