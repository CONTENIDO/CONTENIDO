...
/**
 * This file contains the Con.ContentTypeAbstractTabbed JS class.
 *
 * @module  content-type
...
//    'use strict';
    ...
    /**
     * Creates a new ContentTypeLinkeditor with the given properties.
     * You most probably want to call initialise() after creating a new object of this class.
     *
     * @class ContentTypeLinkeditor
     * @extends ContentTypeAbstractTabbed
     * @constructor
     ...
     */
    ContentTypeLinkeditor = function(frameId, imageId, pathBackend, pathFrontend, idArtLang, id, fields, prefix, session, settings) {

        // call the constructor of the parent class with the same arguments
        Con.ContentTypeAbstractTabbed.apply(this, arguments);
    ...
    // inherit from Con.ContentTypeAbstractTabbed
    ContentTypeLinkeditor.prototype = new Con.ContentTypeAbstractTabbed();
    // correct the constructor function (it points to the Con.ContentTypeAbstractTabbed constructor)
    ContentTypeLinkeditor.prototype.constructor = ContentTypeLinkeditor;

    ContentTypeLinkeditor.prototype = {
        ...
        initialise: function() {
            ...
            Con.ContentTypeAbstractTabbed.prototype.initialise.call(this);
        ...
        loadExternalFiles: function() {
            ...
            Con.ContentTypeAbstractTabbed.prototype.loadExternalFiles.call(this);
            ...
            conLoadFile(this.pathBackend + 'scripts/jquery/ajaxupload.js', ContentTypeLinkeditor.prototype.linkEditorFileUpload, this);
        },
        ...
        addTabbingEvents: function() {
            ...
            Con.ContentTypeAbstractTabbed.prototype.addTabbingEvents.call(self);
        ...
        addSaveEvent: function() {
            ...
            Con.ContentTypeAbstractTabbed.prototype.addSaveEvent.call(self);
        }

    };

    Con.ContentTypeLinkeditor = ContentTypeLinkeditor;

    // @deprecated [2013-10-21] Assign to windows scope (downwards compatibility)
    windows.cContentTypeLinkeditor = ContentTypeLinkeditor;
