...
/**
 * This file contains the ContentTypeImgeditor JS class.
 *
 * @module  content-type
...
//    'use strict';
    ...
    /**
     * Creates a new ContentTypeImgeditor with the given properties.
     * You most probably want to call initialise() after creating a new object of this class.
     *
     * @class ContentTypeImgeditor
     ...
     */
    var ContentTypeImgeditor = function(frameId, imageId, pathBackend, pathFrontend, idArtLang, id, fields, prefix, session, settings) {
    ...
    ContentTypeImgeditor.prototype = new Con.ContentTypeAbstractTabbed();
    // correct the constructor function (it points to the Con.ContentTypeAbstractTabbed constructor)
    ContentTypeImgeditor.prototype.constructor = ContentTypeImgeditor;

    ContentTypeImgeditor.prototype = {
        ...
        loadExternalFiles: function() {
            ...
            conLoadFile(this.pathBackend + 'scripts/jquery/ajaxupload.js', this.initUpload, this);
        },
    ...
    Con.ContentTypeImgeditor = ContentTypeImgeditor;

    // @deprecated [2013-11-10] Assign to windows scope (downwards compatibility)
    window.cContentTypeImgeditor = ContentTypeImgeditor;
