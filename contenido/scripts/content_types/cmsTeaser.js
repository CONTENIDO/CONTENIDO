...
//    'use strict';
     ...
     */
    var ContentTypeTeaser = function(frameId, imageId, pathBackend, pathFrontend, idArtLang, id, fields, prefix, session, settings) {
    ...
    ContentTypeTeaser.prototype = new Con.ContentTypeAbstractTabbed();
    // correct the constructor function (it points to the Con.ContentTypeAbstractTabbed constructor)
    ContentTypeTeaser.prototype.constructor = ContentTypeTeaser;

    ContentTypeTeaser.prototype = {
        /**
    ...
    Con.ContentTypeTeaser = ContentTypeTeaser;

    // @deprecated [2013-11-10] Assign to windows scope (downwards compatibility)
    window.cContentTypeTeaser = ContentTypeTeaser;
