...
/**
 * This file contains the ContentTypeFilelist JS class.
 *
 * @module  content-type
...
//    'use strict';
    ...
    /**
     * Creates a new ContentTypeFilelist with the given properties.
     * You most probably want to call initialise() after creating a new object of this class.
     *
     * @class ContentTypeFilelist
     ...
     */
    var ContentTypeFilelist = function(frameId, imageId, pathBackend, pathFrontend, idArtLang, id, fields, prefix, session, settings) {
    ...
    ContentTypeFilelist.prototype = new Con.ContentTypeAbstractTabbed();
    //correct the constructor function (it points to the Con.ContentTypeAbstractTabbed constructor)
    ContentTypeFilelist.prototype.constructor = ContentTypeFilelist;

    ContentTypeFilelist.prototype = {
         ...
         */
        addManualFileListEvent: function() {
            var self = this;
         ...
         */
        addManualFileListEntry: function() {
        ...
        addSaveEvent: function() {
            ...
            Con.ContentTypeAbstractTabbed.prototype.addSaveEvent.call(this);
        }

    };

    Con.ContentTypeFilelist = ContentTypeFilelist;

    // @deprecated [2013-11-10] Assign to windows scope (downwards compatibility)
    window.cContentTypeFilelist = ContentTypeFilelist;
