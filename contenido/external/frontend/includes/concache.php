...
$sStatCode = '
	...
	if ($GLOBALS[\'db\']->next_record()) {
		...
		$sql  = \'INSERT INTO \'.$GLOBALS[\'cfg\'][\'tab\'][\'stat\'].\' (visited, idcatart, idlang,  idclient) VALUES (1, "\'.Contenido_Security::toInteger($GLOBALS[\'idcatart\']).\'", "\'. Contenido_Security::toInteger($GLOBALS[\'lang\']).\'", "\'. Contenido_Security::toInteger($GLOBALS[\'client\']).\'")\';
	}
	$GLOBALS[\'db\']->query($sql);
';
