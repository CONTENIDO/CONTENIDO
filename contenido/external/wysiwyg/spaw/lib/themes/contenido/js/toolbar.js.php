...
function SPAW_contenido_bt_over(ctrl)
{
  var imgfile = SPAW_base_image_name(ctrl)+"_over.gif";
  ctrl.src = imgfile;
}
function SPAW_contenido_bt_out(ctrl)
{
  var imgfile;
...
function SPAW_contenido_bt_down(ctrl)
{
  var imgfile = SPAW_base_image_name(ctrl)+"_down.gif";
  ctrl.src = imgfile;
}
function SPAW_contenido_bt_up(ctrl)
{
  var imgfile = SPAW_base_image_name(ctrl)+".gif";
  ctrl.src = imgfile;
}
function SPAW_contenido_bt_off(ctrl)
{
