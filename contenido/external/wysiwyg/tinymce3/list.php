...
switch ($_REQUEST['mode']) {
    ...
    case 'media':
        $sql = "SELECT * FROM ".cDb::getTableName('upl')." WHERE idclient='".cSecurity::toInteger($client)."' AND filetype IN ('swf','dcr','mov','qt','mpg','mpg3','mpg4','mpeg','avi','wmv','wm','asf','asx','wmx','wvx','rm','ra','ram') ORDER BY dirname, filename ASC";
        $db->query($sql);
