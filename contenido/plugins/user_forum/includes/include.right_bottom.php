...
if (isset($_GET['idart']) && $_GET['idart'] !== NULL) {
     ...
     * $result[$i]['title']; $formName = $text[$i]['id_user_forum']; // $link =
     * new cHTMLLink(); //
     ...
     * // $test->display(); $edit = new cHTMLLink(); $edit->setCLink($area, 4,
     * 'edit'); $edit->setTargetFrame('left_bottom'); $edit->setCustom('idart',
     * $idart); $edit->setClass('pifa-icon-delete-formd'); $deleteForm =
     ...
     * src="' . $cfg['path/// artikel Online Status , set
     * offline, online bla !!!! $delete = new cHTMLLink();
     * $delete->setCLink($area, 4, 'delete_form');
     * $delete->setTargetFrame('left_bottom'); $delete->setCustom('idart',
     * $idart); $delete->setClass('pifa-icon-delete-form'); $deleteForm =
...
//                         $td = new cHTMLTableData( "User :" .$content['realname'] ."<br>". "Text : " .$content['forum']);
//                         $tr->appendContent($td);
//                         $set = true;
//                     } else {
