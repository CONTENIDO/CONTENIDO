...
$oView->lng_version = i18n('Version', $pluginName);
$oView->lng_author = i18n('Author', $pluginName);
$oView->lng_mail_to_author = i18n('E-Mail to author', $pluginName);
$oView->lng_pluginpage = i18n('Plugin page', $pluginName);
$oView->lng_visit_pluginpage = i18n('Visit plugin page', $pluginName);
$oView->lng_opens_in_new_window = i18n('opens page in new window', $pluginName);
$oView->lng_contenido_forum = i18n('CONTENIDO forum', $pluginName);
$oView->lng_pluginthread_in_contenido_forum = i18n('Plugin thread in CONTENIDO forum', $pluginName);
...
$oView->lng_use_client_name_lbl = i18n('Use client name instead of the id', $pluginName);

$oView->lng_use_language = i18n('Should the language appear in the URL (required for multi language websites)?', $pluginName);
$oView->lng_use_language_lbl = i18n('Prepend language to the URL', $pluginName);
$oView->lng_use_language_name_lbl = i18n('Use language name instead of the id', $pluginName);

$oView->lng_userdefined_separators_header = i18n('Configure your own separators with following 4 settings<br>to control generated URLs to your own taste', $pluginName);
...
$oView->lng_userdefined_separators_example_a = i18n('Category separator has to be different from category-word separator', $pluginName);
...
$oView->lng_userdefined_separators_example_b = i18n('Category separator has to be different from article-word separator', $pluginName);
...
$oView->lng_default_startart_name = i18n('Default article name without extension', $pluginName);
...
$oView->lng_use_lowercase_uri_lbl = i18n('URLs in lower case', $pluginName);
...
$oView->lng_rewrite_urls_at_front_content_output_lbl = i18n('a.) During the output of HTML code of the page', $pluginName);
...
$oView->lng_rewrite_urls_at_front_content_output_info2 = i18n('Differences to variant b.)', $pluginName);
...
$oView->lng_rewrite_urls_at_congeneratecode_lbl = i18n('b.) In modules or plugins', $pluginName);
...
$oView->lng_rewrite_urls_at_congeneratecode_info2 = i18n('Differences to variant a.)', $pluginName);
...
$oView->lng_rewrite_routing = i18n('Routing', $pluginName);
