...
<div class="pseudo-fieldset">
    ...
    {if $field->showField('label')}
        <div class="label">
            ...
            <input type="text" id="label" name="label" value="{$field->get('label')|escape}"
                   maxlength="1023"/>
        </div>
    {/if}
    ...
    {if $field->showField('label')}
        <div class="display_label">
            ...
            <input type="checkbox" id="display_label"
                   name="display_label" {if 1 eq $field->get('display_label')} checked="checked"{/if}/>
        </div>
    {/if}
    ...
    {if $field->showField('uri')}
        <div class="uri">
            ...
            <input type="text" id="uri" name="uri" value="{$field->get('uri')|escape}"
                   maxlength="1023"/>
        </div>
    {/if}
    ...
    {if $field->showField('obligatory')}
        <div class="req-input">
            ...
            <input type="checkbox" name="obligatory"
                   id="obligatory" {if 1 eq $field->get('obligatory')} checked="checked"{/if}/>
        </div>
    {/if}
    ...
    {if $field->showField('default_value')}
        <div class="default_value">
            ...
            <input type="text" id="default_value" name="default_value"
                   value="{$field->get('default_value')|escape}" maxlength="1023"/>
        </div>
    {/if}
    ...
    {if $field->showField('rule')}
        <div class="rule">
            ...
            <input type="text" id="rule" name="rule" value="{$field->get('rule')|escape}"
                   maxlength="1023"/>
        </div>
    {/if}
    ...
    {if $field->showField('error_message')}
        <div class="error_message">
            ...
            <textarea id="error_message" name="error_message" rows="5"
                      cols="30">{$field->get('error_message')|escape}</textarea>
        </div>
    {/if}
    ...
    {if $field->showField('help_text')}
        <div class="help_text">
            ...
            <textarea id="help_text" name="help_text" rows="5"
                      cols="30">{$field->get('help_text')|escape}</textarea>
        </div>
    {/if}
...
{if $field->showField('column_name')}
    ...
    <div class="pseudo-fieldset">
        ...
        <input type="text" id="column_name" name="column_name" value="{$field->get('column_name')}"
               maxlength="64"/>
    </div>
{/if}
{*
