...
$sql = "SELECT A.idcat, level, name,parentid FROM " . cDb::getTableName('cat_tree') . " AS A, " . cDb::getTableName('cat') . " AS B, " . cDb::getTableName('cat_lang') . " AS C WHERE A.idcat=B.idcat AND B.idcat=C.idcat
