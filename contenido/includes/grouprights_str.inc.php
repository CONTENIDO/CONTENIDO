    ...
    $notification->displayNotification("error", i18n("Permission denied"));
        ...
        while ($db->next_record()) {
                ...
                if ($db->f("level") == 0 && $db->f("preid") != 0) {
                        ...
                        $table->cell('<img src="images/spacer.gif" height="1" width="'.($db->f("level")*15).'"><a><img src="images/spacer.gif" width="7" id="'.implode('_', $aRowname).'_img"></a> '.$db->f("name"),"", "", " class=\"td_rights0\"", false);
                        $table->cell("<a href=\"javascript:rightsInheritanceUp('$parentid','$counter[$parentid]')\" class=\"action\"><img border=\"0\" src=\"images/pfeil_links.gif\"></a>    <a href=\"javascript:rightsInheritanceDown('".$db->f("idcat")."')\" class=\"action\"><img border=\"0\" src=\"images/pfeil_runter.gif\"></a>","",""," class=\"td_rights0\"", false);
                        ...
                        foreach($right_list["str"] as $value2){
                         ...
                         $table->cell("<input type=\"checkbox\" name=\"checkall_".$value2["perm"]."_".$value3."_".$db->f("idcat")."\" value=\"\" onClick=\"setRightsFor('".$value2["perm"]."','$value3','".$db->f("idcat")."')\">", "", "",  " class=\"td_rights2\"", false);
                }
}
