...
foreach ($filetypes as $p => $type) {
    $filetypes[$p] = Contenido_Security::escapeDB($type, $db);
}
$filetypes = "'" . implode("','", $filetypes) . "'";

$sql = "SELECT * FROM " . $cfg["tab"]["upl"] . " WHERE idclient='" . Contenido_Security::toInteger($client) . "' AND filetype IN (" . $filetypes . ") ORDER BY dirname, filename";
