...
$cNotification->displayMessageBox(Contenido_Notification::LEVEL_WARNING, 'Sie bearbeiten einen veralteten Content-Typen (CMS_HTMLTEXT). Dieser Content-Typ wird in einer sp�teren Version von CONTENIDO nicht mehr unterst�tzt. Bitte wechseln Sie auf den neuen Content-Typen CMS_TEXT.');
?>
