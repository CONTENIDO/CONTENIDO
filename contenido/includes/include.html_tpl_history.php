 ...
 * {@internal 
 *   created 2008-08-05
 *   $Id: include.html_tpl_history.php 1035 2009-05-07 08:33:50Z timo.trautmann $:
 * }}
 * 
 */
...
if (!$perm->have_perm_area_action($area, 'htmltpl_history_manage'))
{
  ...
  $oPage->render();
    ...
    if($sFileName != "" && $aFileInfo["idsfi"]!="" && $_POST["action"] != "history_truncate" ) {
    	...
    	$sSelectBox = $oVersionHtmlTemp->buildSelectBox("html_tpl_history", i18n("HTML template history"), i18n("Show history entry"), "idhtml_tpl_history");
