...
if (empty($_REQUEST['tmp_file'])) {
	...
	if($backend_file_extensions == "enabled") {
		$editor->displayInfo(i18n("Currently only files with the extension css are displayed in the menu. If you create files with a different extension, they will not be shown on the left side!"));
	}
