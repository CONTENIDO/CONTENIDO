...
global $notification, $right_list, $rights_client, $rights_lang, $db, $lngAct, $groupid, $area_tree, $dataSync;
...
$output = "";
// Select the itemids
$sql = "SELECT * FROM " . cDb::getTableName('tpl') . " WHERE idclient = " . cSecurity::toInteger($rights_client) . " ORDER BY name";
$db->query($sql);
...
while ($db->nextRecord()) {
    ...
    $sJsBefore .= "itemids[\"" . $db->f('idtpl') . "\"]=\"x\";\n";
