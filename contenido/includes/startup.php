...
/*
 * Constants with paths after the last possible place changing via configuration file.
...
/*
 * Constants with URL after the last possible place changing via configuration file.
 * The frontend path point to the current client
 */
