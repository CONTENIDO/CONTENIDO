...
class cHtmlLinkTest extends cTestingTestCase
{
    ...
    public function testConstruct()
    {
        ...
        $this->assertSame(
            '<a class="text_link" href="contenido.org"><img src="path/to/image.jpg" /></a>',
            $this->_link->render()
        );

        $this->_link = new cHTMLLink('contenido.org', '<img src="path/to/image.jpg" />', 'text_link', 'testId');
        $this->assertSame(
            '<a id="testId" class="text_link" href="contenido.org"><img src="path/to/image.jpg" /></a>',
            $this->_link->render()
        );
    }
    ...
    public function testEnableAutomaticParameterAppend()
    {
        ...
        $this->assertSame(
            ...
            $this->_link->getAttribute('onclick')
        );
    }
    ...
    public function testUnSetCustom()
    {
        ...
        $this->assertSame([], $this->_readAttribute($this->_link, '_custom'));
    }
}
