...
class cHtmlTest extends cTestingTestCase {
    ...
    public function testConstruct() {
        ...
        // $this->_readAttribute($this->_cHtml,
        // '_attributes'));
        // $this->assertSame(array('id' => 'm1'),
        // $this->_readAttribute($this->_cHtml,
        // '_attributes'));
    ...
    public function testSetClass() {
        ...
        // $ret = $this->_readAttribute($this->_cHtml,
        // '_attributes');
    ...
    public function testAppendStyleDefinitions() {
        ...
        $this->_cHtml->appendStyleDefinitions([
            'margin-top' => '5px !important',
            'margin-bottom' => '5px !important',
        ]);
        $this->assertSame($ar, $this->_readAttribute($this->_cHtml, '_styleDefinitions'));
...
//var_dump($this->_readAttribute($this->_cHtml, '_requiredScripts'));
    ...
    public function testSetContent() {
        ...
        // $this->_cHtml = new cHTML();
        //
        // var_dump($this->_readAttribute($this->_cHtml, '_content'));
        //
        ...
        // );
        //var_dump($this->_readAttribute($this->_cHtml, '_skeletonOpen'));
    }
    ...
    public function testPAppendContent() {
        ...
        $this->_callMethod($this->_cHtmlReflection, $cHtml, '_appendContent', [['<a href="huhu.php">blabla</a>']]);
        $this->assertSame('<a href="huhu.php">blabla</a><a href="huhu.php">blabla</a>', $this->_readAttribute($cHtml, '_content'));
