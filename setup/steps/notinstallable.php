...
class cSetupNotInstallable extends cSetupMask
{
    ...
    public function __construct(string $reason)
    {
        ...
        if ($reason === 'session_use_cookies') {
            ...
            $this->_stepTemplateClass->set('s', 'REASONTEXT', "Couldn't detect MySQLi extension. You need to enable it in the PHP configuration (see dynamic extensions section in your php.ini). CONTENIDO won't work without that.");
