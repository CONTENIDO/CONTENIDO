...
class cSetupNotInstallable extends cSetupMask
{
    ...
    function cSetupNotInstallable ($sReason)
    {
        ...
        $this->_oStepTemplate->set("s", "ERRORTEXT", "Setup nicht ausf�hrbar / Setup not runnable");
        if ($sReason === 'session_use_cookies') {
            ...
            $this->_oStepTemplate->set("s", "REASONTEXT", "Leider erf�llt Ihr Webserver nicht die Mindestvorraussetzung von PHP " . CON_SETUP_MIN_PHP_VERSION . " oder h�her. Bitte installieren Sie PHP " . CON_SETUP_MIN_PHP_VERSION . " oder h�her, um mit dem Setup fortzufahren.<br><br>Unfortunately your webserver doesn't match the minimum requirement of PHP " . CON_SETUP_MIN_PHP_VERSION . " or higher. Please install PHP " . CON_SETUP_MIN_PHP_VERSION . " or higher and then run the setup again.");
        } else {
