...
INSERT INTO !PREFIX!_actions VALUES('35', '47', '10', 'lang_newlanguage', 'if (!is_numeric($targetclient)) { $targetclient = $client; } $newidlang = langNewLanguage("-- ".i18n("New language")." --",$targetclient);', '', '1');
