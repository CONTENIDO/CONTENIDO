CREATE TABLE `!PREFIX!_pi_user_forum` (`id_user_forum` int(11) NOT NULL auto_increment,`id_user_forum_parent` int(11) NOT NULL,`idart` int(11) NOT NULL default '0',`idcat` int(11) NOT NULL default '0',`idlang` int(5) NOT NULL default '0',`userid` int(6) NOT NULL default '0',`email` varchar(100) NOT NULL default '',`realname` varchar(50) NOT NULL default '',`forum` mediumtext NOT NULL,`forum_quote` mediumtext NOT NULL,`idclient` int(11) NOT NULL,`like` int(11) NOT NULL,`dislike` int(11) NOT NULL,`editedat` datetime NOT NULL default CURRENT_TIMESTAMP,`editedby` varchar(50) NOT NULL default '',`timestamp` datetime NOT NULL default CURRENT_TIMESTAMP,`online` tinyint(1) NOT NULL,`moderated` tinyint(1) NOT NULL DEFAULT '0', PRIMARY KEY (`id_user_forum`)) ENGINE=MyISAM CHARSET=!CHARSET! AUTO_INCREMENT=1;
INSERT INTO `!PREFIX!_plugins` VALUES (1, 1, 'Smarty Wrapper', 'Provides smarty template engine for CONTENIDO Backend and Frontend', 'Bilal Arslan, Andreas Dieter', 'four for business AG', 'info@4fb.de', 'https://www.4fb.de', '1.0.0', 'smarty', '82b117e94bb2cbcbce4e56b79a7d0c23', 1, '2013-02-14 15:10:51', 1);
INSERT INTO `!PREFIX!_plugins` VALUES (2, 1, 'Form Assistant', 'Generating forms in backend, includes data storage and mailing', 'Marcus Gnaß (4fb)', 'four for business AG', 'marcus.gnass@4fb.de', 'https://www.4fb.de', '1.0.0', 'form_assistant', '34E59F15-606A-81F4-1520-59E86230BE37', 2, '2013-02-20 13:24:33', 1);
INSERT INTO `!PREFIX!_plugins` VALUES (3, 1, 'User Forum', 'Administration of user forum entries (Article comments)', 'Claus Schunk (4fb)', 'four for business AG', 'claus.schunk@4fb.de', 'https://www.4fb.de', '1.0.0', 'user_forum', '34E59F15-606A-81F4-1520-59E86230BE38', 3, '2013-05-15 14:29:01', 1);

-- form assistant
CREATE TABLE `!PREFIX!_pifa_contact_de` (`id` int(10) unsigned NOT NULL auto_increment COMMENT 'primary key',`salutation` varchar(255) default NULL,`first_name` varchar(255) default NULL,`last_name` varchar(255) default NULL,`company` varchar(255) default NULL,`street` varchar(255) default NULL,`street_number` varchar(255) default NULL,`plz` varchar(255) default NULL,`city` varchar(255) default NULL,`phone` varchar(255) default NULL,`email` varchar(255) default NULL,`message` text,`privacy` varchar(255) default NULL,PRIMARY KEY (`id`)) ENGINE=MyISAM CHARSET=!CHARSET! AUTO_INCREMENT=11;
...
CREATE TABLE `!PREFIX!_pifa_form` (`idform` int(10) unsigned NOT NULL auto_increment COMMENT 'unique identifier for a ConForm form',`idclient` int(10) unsigned NOT NULL default '0' COMMENT 'id of form client',`idlang` int(10) unsigned NOT NULL default '0' COMMENT 'id of form language',`name` varchar(1023) NOT NULL default 'new form' COMMENT 'human readable name of form',`data_table` varchar(64) NOT NULL default '!PREFIX!_pifo_data' COMMENT 'unique name of data table',`method` enum('get','post') NOT NULL default 'post' COMMENT 'method to be used for form submission', with_timestamp BOOLEAN NOT NULL DEFAULT '1' COMMENT 'if data table records have a timestamp', PRIMARY KEY (`idform`)) ENGINE=MyISAM DEFAULT CHARSET=!CHARSET! COMMENT='contains meta data of PIFA forms' AUTO_INCREMENT=1;
