...
$cfg['path']['frontend']                = '/Applications/XAMPP/xamppfiles/htdocs/ecl/contenido';
...
$cfg['path']['contenido_fullhtml']      = 'http://localhost/ecl/contenido/contenido/';
...
$cfg['db'] = array(
    'connection' => array(
        ...
        'database' => 'contenido',   // (string) The database name which you use
